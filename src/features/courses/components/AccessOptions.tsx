  ...
  return (
    <div className="payment-instructions">
      <div className="payment-heading">
        <Ticket size={19} />
        <div>
          <label htmlFor={id}>Manual payment instructions</label>
          <p>Help students take the next step.</p>
        </div>
        <span className="payment-tag">Shown to students</span>
      </div>
      <textarea
        id={id}
        ...
        rows={4}
        placeholder={
          "Include your course price, how to pay, and where to send the receipt.\nExample: Contact me for payment details, then share your receipt to unlock the course."
        }
        aria-describedby={`${id}-hint`}
      />
      <div className="payment-hint" id={`${id}-hint`}>
        <span>
          Confirm payment, then add the student or share an access coupon.
        </span>
